...
<head>
  ...
  <!-- font-awesome -->
  <script src="https://use.fontawesome.com/5393043fed.js"></script>
</head>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li><a href="<?php echo Yii::app()->createUrl('bms/TDonacion/admin'); ?>"><i class="fa fa-puzzle-piece"></i> <span>Donaciones</span></a></li>
