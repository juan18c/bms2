...
var switcherHTML = '<div id="switcher">';
		...
		for (var i = 0; i < 12; i++) {
			...
			switcherHTML +=    		            '<img src="/bms/themes/bms/img/pattern' + i + '.png" alt="" width="40" height="40" title="pattern' + i + '">';
			switcherHTML +=    		        '</a>';
			switcherHTML +=    		    '</li>';
        	//available patterns
...
var switcherClass = {
	...
	switchColorScheme: function ( e ) {
	    ...
	    jQuery('#color-switcher-link').attr('href', '/bms/themes/bms/css/main' + color + '.css');
	...
	switchDarkLight: function ( e ) {
		...
		jQuery("#box_wrapper > *").each(function() {
			...
			if ((jQuery(this).attr("id") == "topline") || (jQuery(this).attr("id") == "mainslider") || (jQuery(this).hasClass("gradient")) || (jQuery(this).hasClass("cs"))) {
				return;
			}
			...
			} //else if(jQuery(this).hasClass("darkgrey_section")) {
			// 	jQuery(this).toggleClass("grey_section darkgrey_section");
			// } else if(jQuery(this).hasClass("dark_section")) {
			// 	jQuery(this).toggleClass("light_section dark_section");
			// } 
		});
