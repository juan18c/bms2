...
/**
 * This is the model class for table "t_banco".
 *
 * The followings are the available columns in table 't_banco':
...
class TBanco extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre, id_pais, fecha_creacion', 'required'),
			array('id_pais', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_banco, nombre, id_pais, fecha_creacion', 'safe', 'on'=>'search'),
		);
	}
