                ...
                <div class="panel-group" id="accordion">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseDonacion" class="panel-collapse collapse">
                            <div class="panel-body">                                
                                <div class="media">                                    
                                    <div class="media-body">
                                        <?php $this->renderPartial('application.modules.bms.views.tDonacion.adminFront',array('model'=>$modelDonacion,'idResponsable'=>Yii::app()->user->id_persona),false,false); ?>
                                    </div>
                                </div>                                    
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseDireccion" class="panel-collapse collapse">
                            <div class="panel-body">                                
                                <?php $this->renderPartial('application.modules.bms.views.tDatosBasicosDireccion.adminFront',array('modelDBD'=>$modelDBD,'idResponsable'=>Yii::app()->user->id_persona),false,false); ?>
                            </div>
                        </div>
                    </div>
