...
class TDatosBasicosController extends Controller
{
	...
	/*public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				...
				'actions'=>array('create','update','buscarPaciente','buscarPacienteAdmision','buscarAdmisionTipoAsistencia','mostrarAdmin','createIntegrado','createAdmision', 'mostrarPaciente','obtenerCodHistoria','adminPaciente', 'admin','adminPacienteSI'),
	...
	public function actionCreateIntegrado($id_perfil)
	{
		...
		$this->performAjaxValidation($model,$modelDireccion);
		...
		if(isset($_POST['TDatosBasicosDireccion']) && isset($_POST['TDatosBasicos'])) 
		{	
            	...
            	try {
	        		if ($model->save()){
	    				...
	    				if ($modelDireccion->validate()){
	    					...
	    					$guardo=false;
	    					$model->addError('nombres','error al guardar direccion');
	    				}
		...
		$this->render('createIntegrado',array(
			'model'=>$model,'modelUsuario'=>$modelUsuario,'modelDireccion'=>$modelDireccion,'modelMedico'=>$modelMedico));
	}
