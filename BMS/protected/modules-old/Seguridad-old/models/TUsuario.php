...
/**
 * This is the model class for table "seguridad.t_usuario".
 *
 * The followings are the available columns in table 'seguridad.t_usuario':
 * @property integer $id_usuario
 * @property string $usuario
 * @property string $palabra_clave
 * @property integer $nro_intentos
 * @property integer $id_persona
 * @property string $fecha_usuario
 ...
 * @property AuthItem[] $seguridad.AuthItems
 */
class TUsuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_usuario,cedula,confirmar_clave, nro_intentos, id_persona, fecha_usuario, id_estatus,perfil', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('t.fecha_usuario',$this->fecha_usuario,true);
