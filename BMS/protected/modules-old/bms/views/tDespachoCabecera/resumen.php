...
<div class="row">
    ...
    <div class="col-sm-9 col-md-9 col-lg-9">
        ...
        <div class="table-responsive">
            ...
            <?php $this->renderPartial('_viewResumenOrden',array('model'=>$model,'modelCar'=>$modelCar,'modelCartDet'=>$modelCartDet),false,false); ?>
        </div>
    ...
    <div class="col-sm-3 col-md-3 col-lg-3">                
        ...
        <div id="order_review" class="shop-checkout-review-order">
            ...
            <?php $this->renderPartial('_viewTotalDespacho',array('resumenCart'=>$resumenCart,'modelOrden'=>$modelOrden,'envio'=>$envio,'gastos'=>$gastos,'paisDestino'=>$paisDestino,'paisAbreviatura'=>$paisAbreviatura),false,false); ?>
            </div>
