...
<div class="row">
    ...
    <div class="col-sm-3 col-md-3 col-lg-3">                
        ...
        <h3 class="widget-title" id="order_review_heading">Pre-Orden</h3>
        <div id="order_review" class="shop-checkout-review-order">
            <div id="shop-order-div">
            <?php $this->renderPartial('application.modules.bms.views.tCotizacion._viewTotalOrden',array('resumenCart'=>$resumenCart),false,false); ?>
            </div>
