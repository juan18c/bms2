			...
			<?php $form=$this->beginWidget('CActiveForm', array(
				...
				<div class="form-group clearfix">
					...
					<div class="col-lg-3" style="padding-left: 0; margin-bottom:15px;">
						...
						<input type="text" name="montoConciliado" id="montoConciliado" class="form-control" value="<?php echo $model->pago_acumulado; ?>" readonly>
					</div>
					<div class="col-lg-3" style="padding-left: 0; margin-bottom:15px;">
						<label>Monto Restante</label>
						<input type="text" name="montoRestante" id="montoRestante" class="form-control" value="0" readonly>
					</div>
				</div>
				...
				?>
							...
							<div class="form-group clearfix">
								...
								<div class="col-lg-2" style="padding-left: 0; margin-bottom:15px;">
									...
									<input type="text" name="montoRecibidoPaypal" id="montoRecibidoPaypal" class="form-control monto-a-pagar" placeholder="0.00" value="<?php echo $value->monto_recibido_conciliado; ?>" readonly>
								</div>

								<div class="col-lg-2" style="padding-left: 0; margin-bottom:15px;">
									<label>Fecha</label>
									<input type="text" name="fechaRecibidoPaypal" id="fechaRecibidoPaypal" class="form-control" value="<?php echo $value->fecha_pago_conciliado; ?>" readonly>
								</div>
				...
				?>
							...
							<div class="form-group clearfix">
								...
								<div class="col-lg-2" style="padding-left: 0; margin-bottom:15px;">
									<label>Monto Recibido</label>
									<input type="text" name="montoRecibidoDeposito" id="montoRecibidoDeposito" class="form-control monto-a-pagar" placeholder="0.00" value="<?php echo $value->monto_recibido_conciliado; ?>" readonly>
								</div>

								<div class="col-lg-2" style="padding-left: 0; margin-bottom:15px;">
									<label>Fecha</label>
									<input type="text" name="fechaRecibidoDeposito" id="fechaRecibidoDeposito" class="form-control" value="<?php echo $value->fecha_pago_conciliado; ?>" readonly>
								</div>
				...
				?>
							...
							<div class="form-group clearfix">
								<div class="col-lg-3" style="padding-left: 0; margin-bottom:15px;">
									<label>Monto Recibido</label>
									<input type="text" name="montoRecibidoEfectivo" id="montoRecibidoEfectivo" class="form-control monto-a-pagar" placeholder="0.00" value="<?php echo $value->monto_recibido_conciliado; ?>" readonly>						
								</div>					

								<div class="col-lg-3" style="padding-right: 0; margin-bottom:15px;">
									<label>Fecha</label>
									<input type="text" name="fechaRecibidoEfectivo" id="fechaRecibidoEfectivo" class="form-control" value="<?php echo $value->fecha_pago_conciliado; ?>" readonly>
								</div>
				...
				<div class="form-group clearfix">
					<button class="btn btn-primary" type="button" id="" name=""><i class="fa fa-save"></i> Cerrar</button>
				</div>
