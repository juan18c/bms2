...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'tcotizacion-beneficiario-historia-form',
...
<div id="divHistoriaMedicaMensaje"></div>
...
<div style="display:none;margin:0px;" id="newDivHistoriaBene" class="row well">
    ...
    <div class="form-group">
    	<button class="btn btn-primary pull-right" type="submit" id="THistoriaMedica_crear_historia" name="THistoriaMedica_crear_historia"><i class="fa fa-plus-circle "></i> A&ntilde;adir Documento</button>
    </div>
