    ...
    $.ajax({
        ...
        success : function (data) {                    
           if (data.salida == 'COMPLETO') {  
                    var men='<div class=\'alert alert-success alert-dismissible\' role=\'alert\'><button type=\'button\' class=\'close\' data-dismiss=\'alert\' aria-label=\'Close\'><span aria-hidden=\'true\'>&times;</span></button><i class=\'glyphicon glyphicon-ok-sign\'></i> Se modifico exitosamente su caso.</div>' ;                 
                    $('#divDonacionMensaje').html(men);
        ...
        'enctype' => 'multipart/form-data'),
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-3">                     
                      <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                ?>
                                <input type="hidden" id="foto" name="foto" value="<?php echo $fotoDonacion; ?>">
			    	...
			    	<div class="col-xs-9"> 
                        ...
                        <br>
							<hr>
              <?php if ((Yii::app()->user->getState('id_rol') != 'admin')){ ?>
							<button class="btn btn-primary pull-right"  id="enviarDatos" name="enviarDatos" style="background-color:#820906"><i class="fa fa-save"></i> Guardar Donaciónn</button>
               <?php } ?>
			      	</div>
			    </div>
