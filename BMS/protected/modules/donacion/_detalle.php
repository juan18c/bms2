    ...
    <div class="row">
    	...
    	<div class="col-md-4">
            <ul class="list-group">
              <li class="list-group-item">
              	 <div >
                <a style="float:right;margin-right: -190px;margin-top:-7px" class="ejemplo_4"  title="" href="<?php echo $model->video; ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/video.png" width="15%" hight="15%" class="tooltips" data-toggle="tooltip" data-original-title="Video del Caso"></a>
                 </div>
                ...
                <a style="float:right;margin-right: 5px" class="fa fa-file-pdf-o fa-2x tooltips" data-toggle="tooltip" data-original-title="Ver Cotización" target="_blank" title="" href="<?php echo "/bms/index.php/bms/TCotizacion/update/id/".$model->id_cotizacion; ?>" ></a>
               
              </li>
          	  <li class="list-group-item">Fecha Creación  <span class="badge"><?php echo date( 'd-m-Y',strtotime($model->fecha_creacion)) ?></span>
              </li>
            ...
            <button class="btn btn-primary pull-right" type="button" id="compartir" onClick="window.open('https://www.facebook.com/sharer.php?s=100&p[url]=http://www.biometabolicservice.com/index.php/site/detalleCaso?idDonacion=<?php echo $model->id_donacion; ?>&s=100&p[title]=Conoce+a+Developando&p[images][0]=http://developando.com/images/developandoLogo.jpeg&p[summary]=Desarrollo+web+y+movil')" name="compartir" style="background-color:#337ab7" target="_blank"><img src="https://lh3.googleusercontent.com/-H8xMuAxM-bE/UefWwJr2vwI/AAAAAAAAEdY/N5I41q19KMk/s32-no/facebook.png" width="20px" height="20px"> Compartir</button>

          <?php if ($model->id_estatus==1){ ?>   
      		<button class="btn btn-primary pull-right" type="submit" id="enviarDonacion" onclick="js:$('#modalPagoDonacion').modal('show');" name="enviarDonacion" style="background-color:#820906"><i class="fa fa-save"></i> &nbsp;&nbsp;&nbsp;&nbsp;Donar &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
           <?php } ?>   
      </div> 
      ...
      <div class="col-md-12">
        <ul class="nav nav-tabs" role="tablist">                    
          <li class="active">
          <a href="#caso" role="tab" data-toggle="tab">Detalles del Caso</a>
          </li>
          <li class="">
