...
/**
 * This is the model class for table "bms_seguridad.t_auditoria".
 *
 * The followings are the available columns in table 'bms_seguridad.t_auditoria':
...
class TAuditoria extends CActiveRecord
{
	...
	{
		return 'bms_seguridad.t_auditoria';
	}
