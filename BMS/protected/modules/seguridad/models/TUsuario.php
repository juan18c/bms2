...
class TUsuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('usuario, palabra_clave,confirmar_clave', 'required','message'=>Yii::t("translation", "{attribute} Requerido.")),
			array('usuario', 'email','message'=>"Correo no es correcto."),
			array('usuario', 'unique','message'=>"Email ya se encuentra registrado."),
