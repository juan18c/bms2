...
class TDonacion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_cotizacion, id_estatus', 'numerical', 'integerOnly'=>true),
			array('monto_acumulado', 'numerical'),
			...
			array('id_donacion, codigo_donacion, id_cotizacion, monto_acumulado,monto_solicitado, diagnostico, sintomas,nombre_caso, resumen, objetivo, foto, video, id_estatus, fecha_creacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		//$criteria->together = true;
 		//$criteria->with= array('idEstatus','idEstatus.id_estatus');
