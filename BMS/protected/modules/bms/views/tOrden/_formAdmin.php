...
<div class="row">
	<div class="col-md-12">
        ...
        <button class="btn btn-primary pull-right" type="submit" id="TCotizacion_pagar_orden" name="buttonPagarOrden"><i class="fa fa-money"></i> Pagar Orden</button>
		...
		<button class="btn btn-primary pull-right" type="submit" id="TCotizacion_pagar_orden" name="buttonPagarOrden" data-toggle="modal" data-target="#modalPagoCot"><i class="fa fa-money"></i> Pagar Orden</button>
