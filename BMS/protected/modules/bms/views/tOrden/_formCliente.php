...
<div class="row">
	<div class="col-md-12">
        ...
        <ul class="nav nav-tabs pull-right">
            <li>
               <button class="btn theme_button" type="submit" id="TCotizacion_pagar_orden" name="buttonPagarOrden" style="margin-top:-80px;margin-right:0px;"><i class="fa fa-money"></i> Pagar Orden</button>
            </li>
        </ul>
        ...
        <div class="tab-content top-color-border bottommargin_30">        	    		
            ...
            <div class="tab-pane fade in active" id="carrito">
                ...
                <?php
					$this->renderPartial('application.modules.bms.views.tOrden.resumenOrden',array(
		...
		<button class="btn theme_button pull-right" type="submit" id="TCotizacion_pagar_orden" name="buttonPagarOrden" data-toggle="modal" data-target="#modalPagoCot"><i class="fa fa-money"></i> Pagar Orden</button>
