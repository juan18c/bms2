...
$this->menu=array(	
	...
	//array('label'=>'Crear Paciente sin ID', 'url'=>array('createIntegrado', 'id_perfil'=>'8')) 
);
...
<div class="row-fluid">
	<div class="span12">
		<h1 class="heading">Pacientes Sin Identificacion</h1>
	</div>
...
<div class="row-fluid">
	<?php 
		$criteria= new CDbCriteria;
 		...
 		$criteria->condition="t.id_tipo_identificacion=5 ";
				...
				array('header' =>'Opciones', 'class'=>'bootstrap.widgets.TbButtonColumn',
				    ...
				    (
				        ...
				        (
				            ...
				            'icon'=>'folder-close',
				            //'imageUrl'=>'',
				            'options'=>array('title'=>'Ver Historia'),
