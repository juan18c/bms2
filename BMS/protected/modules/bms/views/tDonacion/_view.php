...
$beneficiario=$data->idCotizacion->idBeneficiario->idBeneficiarioDB->nombres." ".$data->idCotizacion->idBeneficiario->idBeneficiarioDB->apellidos;
$responsable= $data->idCotizacion->idResponsable->nombres." ".$data->idCotizacion->idResponsable->apellidos;
    ...
    <div class="side-item">
        ...
        <div class="row">
            ...
            <div class="col-md-8" style="padding: 8px 20px 8px 20px;"> <!-- style="padding: 5px;" -->
                ...
                <div class="progress-label" style="font-size: 14px">
                   <?php
                ...
                <div class="progress">
                 ...
                 <p class="product-description">
                    <?php
                        ...
                        echo "<label style='font-weight: bold;'>País:&nbsp;&nbsp;&nbsp;</label>".TDatosBasicosDireccion::model()->findByPk($data->idCotizacion->idCarrito->id_direccion)->idPais->descripcion; 
                    ?>
                </p>
