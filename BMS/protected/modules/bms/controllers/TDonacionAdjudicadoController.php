...
class TDonacionAdjudicadoController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','modalDonacionAdjudicado','createAdmin','updateEstatus','adminDonador'),
				'users'=>array('@'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','adminDonador'),
				'users'=>array('admin'),
			),
	...
	public function actionAdminDonador($idDonador)
	{
		//echo "entro";
		$model=new TDonacionAdjudicado('search');
		//print_r($model);
		...
		$this->render('adminDonador',array(
			'model'=>$model,'idDonador'=>$idDonador
		));
	}
